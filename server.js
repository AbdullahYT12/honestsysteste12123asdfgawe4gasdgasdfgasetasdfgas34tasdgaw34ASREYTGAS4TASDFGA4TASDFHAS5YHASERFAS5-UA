...
app.listen(() => console.log("Honest. started"));
...
client.on("message", message => {
  if (message.content.toLowerCase() === prefix + "help") {
    ...
    let help = new Discord.MessageEmbed()
      ...
      .addField(
        `General`,
        `> **${prefix}user ${prefix}server ${prefix}avatar ${prefix}roles ${prefix}emojis ${prefix}ping ${prefix}find ${prefix}discrim ${prefix}grole ${prefix}credits ${prefix}daily**`,
        true
      )
      .addField(
        `Moderation`,
